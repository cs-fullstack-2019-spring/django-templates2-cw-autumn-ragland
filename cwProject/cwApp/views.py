...
# render home page
def index(request):
    return render(request, 'cwApp/movies.html', {'movie_list': movies})


# render details page
def details(request, movie_ID):
    return render(request, 'cwApp/movie_details.html',  {'movie_list': movies[movie_ID]})


# render synop page
def synop(request, movie_ID):
    return render(request, 'cwApp/movie_synopsis.html',  {'movie_list': movies[movie_ID]})
